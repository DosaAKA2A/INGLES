...
CURSO.push({
  ...
  ejercicios: [
    ...
    { tipo: 'traduce', es: 'Soy de Perú.', en: ['i am from peru', "i'm from peru"], vocabIdx: 3 },
  ...
  examen: [
    ...
    { tipo: 'opcion', literal: true, q: '¿Cuál está bien escrita?', opciones: ['i speak english', 'I speak English', 'I speak english'], r: 1, di: 'I speak English' },
